...
public class Controller {
    ...
    //these variables correspond to the <top> of main-window-view.fxml
    @FXML
        ...
        */
        ...
        deleteStudent.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                 ...
                 */
                Student deleteStu = studentListView.getSelectionModel().getSelectedItem();
                deleteStudent(deleteStu);
            }
        });
        ...
        editStudent.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                 ...
                 */
                Student editStu = studentListView.getSelectionModel().getSelectedItem();
                editStudent(editStu);
            }
        });
        ...
        studentListView.setCellFactory(new Callback<ListView<Student>, ListCell<Student>>() {
            public ListCell<Student> call(ListView<Student> param) {
                ...
                //code included as part of the deleted
         ...
         */
        Comparator<Student> stuCom = Comparator.comparing(Student::getYearOfStudy);
        SortedList<Student> sortedByYear = new SortedList<>(StudentData.getInstance().getStudents(), stuCom);
    ...
    public void editStudent(Student stu) {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            studentListView.getSelectionModel().select(ec.processEdit(editStudent));
        }
    }
}